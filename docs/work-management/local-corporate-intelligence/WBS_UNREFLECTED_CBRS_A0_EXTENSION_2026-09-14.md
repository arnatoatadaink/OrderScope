...
| UWBS-031 | Add CBRS competitor-divergence Canary fixture | A0 QA / Market Reaction QA | Reproduce NVDA-led theme strength, competitor divergence, broad/rate-pressure selloff, positive company catalyst, rebound with relative volume expansion, overshoot and later stabilization; include false-positive cases | A0-002; UWBS-027..030 | Ready for WBS design | Canary fixture implemented; local acceptance pending |
