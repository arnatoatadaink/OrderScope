# OrderScope — L1-003 PB-07 Stability Change-Window Authorization
...
Only the bounded PB-07 stability observation window is authorized.
...
This authorization does not include PB-08, PB-09, PB-10, pause/resume, News
activation, retention widening, Universe changes, Cron changes, priority
changes, or manual checkpoint movement.
