...
| L1-003 Phase B start-readiness WBS/CP | Active plan; version-8/9 closeout reconciled read-only at `2026-09-17T18:36:43Z`; snapshot remaining recovery is 2,730 bars/28 session-bounded chunks through the existing September 15 target, or 3,120 bars/32 chunks through September 16 close; moving 24-hour retention requires target re-freeze before a campaign; normal-scheduler handoff, two-opportunity stability evidence and separate Phase B authorization remain mandatory |
...
- L1-003 / SMOKE-007 PB-01 moving-horizon read-only preflight and PB-02 bounded campaign-shape review; then locally accept and separately authorize the remaining recovery campaign, hand off to the unchanged normal scheduler, and observe at least two clean opportunities. Only after those gates may a separately authorized market-session Phase B window create and catch up a fresh pause-created gap. Phase A and four remote recovery chunks through NVDA checkpoint version 10 are accepted.
