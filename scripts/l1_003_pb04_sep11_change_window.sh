...
PACKET="${PB04_PACKET:-var/l1-003/local-market-recovery/nvda/PB04_NVDA_2026-09-11_REMOTE_PACKET.json}"
EVIDENCE="${PB04_EVIDENCE:-var/l1-003/local-market-recovery/nvda/NVDA_1Min_REGULAR_2026-09-11.json}"
...
if (packet.schemaVersion !== "l1-003-pb04-remote-execution-packet-v1"
  ...
  || packet.frozenRemoteCheckpoint?.version !== 26
  || packet.frozenRemoteCheckpoint?.completeThrough !== "2026-09-10T20:00:00.000Z"
  || packet.source?.marketDate !== "2026-09-11"
  || packet.source?.contentSha256 !== evidence.contentSha256
  || evidence.contentSha256 !== "a41dcb05888182dada5dbde3fc420b74684abaac6e5f2aafcdb5fa81d8e8be90"
  || packet.recoveryId !== "L1-003-NVDA-20260911-LOCAL"
  || packet.chunks?.length !== 4) {
  throw new Error("Sep11 packet/evidence frozen identity mismatch");
}
...
echo
echo "== execute frozen Sep11 four-chunk campaign =="
...
echo "PB-04 Sep11 campaign: ACCEPTED REMOTELY at v30 / 2026-09-11T20:00:00.000Z"
